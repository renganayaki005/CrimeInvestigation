...
public final class trackCase_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String status="";
      ...
      out.write("        <title>Track Case</title>\n");
      out.write("        <script type=\"text/javascript\">\n");
      out.write("function view(){\n");
      out.write("var Id=document.getElementById(\"Id\").value;\n");
      out.write("alert(Id);\n");
      out.write("window.location.replace(\"trackCase.jsp?Id=\"+Id);\n");
      out.write("}\n");
      out.write("</script>\n");
      out.write("        <style>\n");
      out.write("    .btn {\n");
      ...
      out.write("</div> <br/>\n");
      out.write("<form method=\"post\" name=\"trackCase\">\n");
      out.write("  <div class=\"container\">\n");
      out.write("     <h1>Track Case!</h1>\n");
  ...
  while(rs.next()){ 
   ...
   try{
    ...
    ResultSet rs=st.executeQuery("select * from case where Id='"+caseId+"'");
    if(rs.next()){
     ...
     }catch(Exception e)
   {
      ...
      out.write("    <textarea name=\"caseDesc\" rows=\"10\" cols=\"50\" required>");
      out.print(caseDesc);
      out.write("</textarea><br/>\n");
      out.write("    \n");
      out.write("    <label for=\"statusLabel\"><b></b></label>\n");
      out.write("    <input type=\"text\" value=\"");
      out.print(status);
